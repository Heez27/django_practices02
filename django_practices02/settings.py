"""
Django settings for django_practices02 project.
...
SECRET_KEY = 'h=po2-(f0#m)%8egli@a)vgwe)-_rvhau-3^e-k3-v)w(o#u%d'
...
ROOT_URLCONF = 'django_practices02.urls'
...
WSGI_APPLICATION = 'django_practices02.wsgi.application'
